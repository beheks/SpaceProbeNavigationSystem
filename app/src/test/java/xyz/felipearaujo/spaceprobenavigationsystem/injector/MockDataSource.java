...
public class MockDataSource implements TrackingService {
    ...
    return Observable.create(new Observable.OnSubscribe<DirectionsResponse>() {
      ...
      public void call(Subscriber<? super DirectionsResponse> subscriber) {
        if(!subscriber.isUnsubscribed()) {
          ...
          subscriber.onNext(new DirectionsResponse(getDirectionsList()));
        }
        if(!subscriber.isUnsubscribed()) {
  ...
  public static List<String> getDirectionsList() {
    return Arrays.asList("FORWARD", "FORWARD", "FORWARD", "RIGHT", "FORWARD", "FORWARD", "RIGHT",
        "FORWARD", "LEFT", "FORWARD", "LEFT", "FORWARD", "FORWARD", "FORWARD", "LEFT", "FORWARD",
        "FORWARD", "LEFT", "FORWARD", "FORWARD", "LEFT", "FORWARD", "FORWARD", "FORWARD", "FORWARD",
        "RIGHT", "FORWARD", "FORWARD", "LEFT", "FORWARD", "FORWARD", "FORWARD", "RIGHT", "RIGHT",
        "FORWARD", "FORWARD", "LEFT", "FORWARD", "RIGHT", "FORWARD", "FORWARD");
  }
}
